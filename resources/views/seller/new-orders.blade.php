        ...
        <div id="sellers-result-box">
            ...
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a href="{{route('seller.orders.new')}}" class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active ">New Orders</a>
                    </li>
                    <li class="me-2">
                        <a href="{{route('seller.orders.awaiting')}}" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300">
                            Awaiting Orders
                        </a>
                    </li>
                </ul>
                ...
                <table class="w-full text-lg text-left rtl:text-right text-gray-500 " id="seller-pending-products-table">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 ">
                            ...
                            <td class="px-6 py-4">
                                <form action="{{route('seller.order.await', $order->id)}}" method="POST">
                                    @csrf
