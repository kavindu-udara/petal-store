            ...
            <div id="sellers-result-box">
                ...
                <div class="text-xl font-medium text-center text-gray-500 ml-5">
                    <ul class="flex flex-wrap -mb-px">
                        <li class="me-2">
                            <a href="{{route('seller.products.pending.list')}}" class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active ">Pending Products</a>
                        </li>
                        <li class="me-2">
                        ...
                        <li class="me-2">
                            <a href="{{route('seller.products.hidden.list')}}" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300">
                                Hidden Products
                            </a>
                        </li>
                        <li class="me-2">
