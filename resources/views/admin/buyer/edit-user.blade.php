    ...
    <div class="md:flex md:flex-row">
        ...
        <div class="md:basis-2/3">
            <div class="p-5 w-full mx-auto bg-white md:mt-10 shadow-lg shadow-slate-400/50 rounded sm:w-3/4">
                ...
                <form action="{{route('admin.user.update', $profile->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="md:flex md:flex-row gap-4">
                        ...
                        <div class="md:basis-3/4">
                            <div class="text-gray-400 text-3xl text-center md:text-left">Edit Profile</div>
