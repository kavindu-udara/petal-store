        ...
        <div id="sellers-result-box">
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                ...
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a href="{{route('admin.users')}}" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300">
                            All Buyers
                        </a>
                    </li>
                    <li class="me-2">
                        <a href="{{route('admin.users.suspended')}}"  class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active">
                            Suspended Buyers
                        </a>
                    </li>
                    <li class="me-2">
                ...
                <table class="w-full text-lg text-left rtl:text-right text-gray-500" id="buyer-all-table">
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50 ">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button onclick="showandHidePopup('user-unsuspend-pop-up-{{$user->id}}');" class="p-3 bg-emerald-200 rounded-xl cursor-pointer hover:bg-emerald-200 hover:text-white">
                                    Unsuspend
                                </button>
                        ...
                        <!-- user unsuspend popup -->
                        <section id="user-unsuspend-pop-up-{{$user->id}}" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    <div class="text-center text-xl mb-5">Are You Sure ?</div>

                                    <form action="{{route('admin.user.unsuspend', $user->id )}}" method="POST">
                                        @csrf

                                        <div class="grid grid-cols-2 gap-4">
                                            <button class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</button>
                                            <div onclick="showandHidePopup('user-unsuspend-pop-up-{{$user->id}}');" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400">No</div>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            @else
                ...
                <div class="text-center text-xl">No suspended buyers</div>
