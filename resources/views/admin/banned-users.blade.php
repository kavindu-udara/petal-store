            ...
            <div class="relative overflow-x-auto sm:rounded-lg mx-5 mt-3">
                ...
                <table class="w-full text-lg text-left rtl:text-right text-gray-500" id="buyer-all-table">
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50 ">
                        ...
                        <!-- user unban popup -->
                        <section id="user-unban-pop-up-{{$user->id}}" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    <div class="text-center text-xl mb-5">Are You Sure ?</div>
                                    ...
                                    <form action="{{route('admin.user.unban', $user->id )}}" method="POST">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <button class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</button>
                                            <div onclick="showandHidePopup('user-unban-pop-up-{{$user->id}}');" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400">No</div>
                                        </div>
                                    </form>
                                </div>
                            </div>
