        ...
        <div id="sellers-result-box">
            ...
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                <ul class="flex flex-wrap -mb-px">
                    ...
                    <li class="me-2">
                        <a href="{{route('admin.products.all')}}" class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active">
                            All Products
                        </a>
                    </li>
                    <li class="me-2">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 ">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button onclick="showandHidePopup('product-hide-pop-up-{{$product->id}}');" class="p-3 bg-red-200 rounded-xl  cursor-pointer hover:text-white hover:bg-red-300">
                                    Hide
                                </button>

                                <button onclick="showandHidePopup('product-pending-pop-up-{{$product->id}}');" class="p-3 bg-red-200 rounded-xl  cursor-pointer hover:text-white hover:bg-red-300">
                                    Pending
                                </button>
                        ...
                        <section id="product-hide-pop-up-{{$product->id}}" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    ...
                                    <form action="{{route('admin.product.hide', $product->id )}}" method="POST">
                                        @csrf

                                        <div class="grid grid-cols-2 gap-4">
                                            <button class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</button>
                                            <div onclick="showandHidePopup('product-hide-pop-up-{{$product->id}}');" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400">No</div>
                                        </div>
                                    </form>
                                </div>
                            </div>
