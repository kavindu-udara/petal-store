        ...
        <div id="sellers-result-box">
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                <ul class="md:flex md:flex-wrap -mb-px ">
                    <li class="me-2">
                        <a href="{{route('admin.sellers.pending')}}" class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active ">
                            Pending Sellers
                        </a>
                    </li>
                    <li class="me-2">
                ...
                <div class="flex justify-end gap-5 mr-10">
                    <div class="mb-3">
                        <a href="{{route('admin.seller.pdf.pending')}}" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400 font-bold">Print</a>
                    </div>
                </div>
                @endif
            ...
            <table class="w-full text-lg text-left rtl:text-right text-gray-500" id="seller-pending-table">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 ">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button onclick="showandHidePopup('seller-disapprove-pop-up-{{$seller->id}}');" class="p-3 bg-red-200 rounded-xl  cursor-pointer hover:text-white hover:bg-red-300">
                        ...
                        <!-- product shipped popup -->
                        <section id="seller-disapprove-pop-up-{{$seller->id}}" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    <div class="text-center text-xl mb-5">Are You Sure ?</div>

                                    <form action="{{route('admin.seller.disapprove', $seller->id)}}" method="POST">
                                        @csrf

                                        <div class="grid grid-cols-2 gap-4">
                                            <button class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</button>
                                            <div onclick="showandHidePopup('seller-disapprove-pop-up-{{$seller->id}}');" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400">No</div>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="text-center text-xl font-medium text-gray-500 mt-10">No Pending Seller</div>
