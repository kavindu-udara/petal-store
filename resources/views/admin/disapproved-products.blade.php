        ...
        <div id="sellers-result-box">
            ...
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                ...
                <div class="flex justify-end gap-5 mr-10">
                    <div class="mb-3">
                        <a href="{{route('admin.product.pdf.disapproved')}}" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400 font-bold">Print</a>
                    </div>
                </div>
            </div>
