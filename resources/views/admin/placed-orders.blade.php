        ...
        <div id="sellers-result-box">
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a href="{{route('admin.order')}}" class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active ">
                            Placed
                        </a>
                    </li>
                    <li class="me-2">
                        <a href="{{route('admin.order.awaiting')}}" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300">Awaiting Shipment</a>
                    </li>
                    <li class="me-2">
                ...
                <div class="flex justify-end gap-5 mr-10">
                    <div class="mb-3">
                        <a href="{{route('admin.order.pdf.placed')}}" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400 font-bold">Print</a>
                    </div>
                </div>
