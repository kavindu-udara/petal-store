    ...
    <div class="md:flex md:flex-row">
        ...
        <div class="md:basis-2/3">
            <div class="p-5 w-full mx-auto bg-white md:mt-10 shadow-lg shadow-slate-400/50 rounded sm:w-3/4 ">
                ...
                <div>
                    <form action="{{route('admin.seller.update', $profile->id)}}" method="POST" enctype="multipart/form-data" class="md:flex md:flex-row gap-4">
                        ...
                        <div class="md:basis-3/4 ">
                            ...
                            <div class="mt-5 grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input id="seller-profile-first-name" type="text" class="w-full bg-slate-200 py-2 px-3 " value="{{$profile->fname}}" name="first_name" required>
                                </div>
                                <div>
                                    <div class="uppercase">last name</div>
                                    <input id="seller-profile-last-name" type="text" class="w-full bg-slate-200 py-2 px-3 " value="{{$profile->lname}}" name="last_name" required>
                                </div>
                                <div>
                                    <div class="uppercase">shop name</div>
                                    <input id="seller-profile-nick-name" type="text" class="w-full bg-slate-200 py-2 px-3 " value="{{$profile['shop-name']}}" name="shop_name" required>
                                </div>
                                <div>
                                    <div class="uppercase">nic</div>
                                    <input id="seller-profile-nic-number" type="text" class="w-full bg-slate-200 py-2 px-3 " value="{{$profile->nic}}" name="nic_no" required>
                                </div>
                            </div>
                            <div class="mt-5 grid grid-cols-2 gap-4">
                                <div>
                                    <div class="uppercase text-gray-500 ">joined date-time</div>
                                    <input type="text" class="w-full bg-slate-200 text-gray-600 py-2 px-3 " disabled value="{{$profile->created_at}}" value="2024-12-05">
                                </div>
                                <div>
                                    <div class="uppercase">mobile</div>
                                    <input id="seller-profile-mobile" type="text" class="w-full bg-slate-200 py-2 px-3 " value="{{$profile->mobile}}" name="mobile" required>
                                </div>
                            </div>
                            <div class="mt-5">
                                <div>
                                    <div class="uppercase">email</div>
                                    <input id="seller-profile-email" type="email" class="w-full bg-slate-200 py-2 px-3" value="{{$profile->email}}" name="email" required>
                                </div>
                            </div>
                            <div class="mt-5">
