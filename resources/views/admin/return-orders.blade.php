        ...
        <div id="sellers-result-box">
            <div class="text-xl font-medium text-center text-gray-500 ml-5">
                <ul class="flex flex-wrap -mb-px">
                    ...
                    <li class="me-2">
                        <a href="{{route('admin.order.return')}}" class="inline-block p-4 text-emerald-600 border-b-2 border-emerald-600 rounded-t-lg active ">
                            Return Requested
                        </a>
                    </li>
                </ul>
                ...
                <div class="flex justify-end gap-5 mr-10">
                    <div class="mb-3">
                        <a href="{{route('admin.order.pdf.return')}}" class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400 font-bold">Print</a>
                    </div>
                </div>
                @endif
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 ">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-red-400">Return Cancelled</div>

                                @elseif ($order->status=='8')

                                <div class="text-emerald-400">Added to Stock</div>
                        ...
                        <section id="order-add-to-stock-pop-up-{{$order->id}}" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    ...
                                    <form action="{{route('admin.order.update.add.to.stock.return', $order->id)}}" method="POST">
                                        @csrf
                        ...
                        <section id="order-cancel-pop-up-{{$order->id}}" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    ...
                                    <form action="{{route('admin.order.update.return.cancel', $order->id )}}" method="POST">
                                        @csrf
                                        <div class="grid grid-cols-2 gap-4">
                                            <button class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</button>
                        ...
                        <!-- order cancel popup -->
                        <section id="order-cancel-pop-up-5" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    <div class="text-center text-xl mb-5">Are You Sure ?</div>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</div>
                                        <div class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400">No</div>
                                    </div>
                                </div>
                            </div>
                        </section>

                        <!-- order awaiting popup -->
                        <section id="order-awaiting-pop-up-" class="fixed top-0 left-0 w-full h-full opacity-100  backdrop-blur-sm justify-center items-center rounded hidden">
                            <div class="h-screen flex items-center justify-center">
                                <div class="bg-white p-10 rounded-lg shadow-sm ">
                                    <div class="text-center text-xl mb-5">Are You Sure ?</div>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="py-3 px-10 bg-red-300 rounded-lg text-lg text-center cursor-pointer hover:bg-red-400">Yes</div>
                                        <div class="py-3 px-10 bg-emerald-300 rounded-lg text-lg text-center cursor-pointer hover:bg-emerald-400" onclick="hideBox('order-awaiting-pop-up-');">No</div>
                                    </div>
                                </div>
                            </div>
                        </section>
